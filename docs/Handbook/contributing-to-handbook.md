...
## Create an Issue {#9da9b0fc18c24c49b439b0df50ecbb02}


All contributions require the creation of an issue.


In the issue, include a brief description, and suggest a title and path for the change. The path should include the filename, and its location in the file hierarchy, of a new or existing file. A new or existing section should be suggested for changes to existing files.


## Create a Draft {#33eb2478127c4a0c80b540c3a58e303f}

- Start a draft on Notion.
- Invite collaborators to review and/or collaborate on the draft.
- Iterate on the draft until a final version is produced and approved.
- Export the draft to a Markdown document.

## Make a Pull Request {#a9e3ddcc6de24af48a0589017f4678b3}

- Clone this repo, create a local branch, and commit the Markdown document.
- Publish the local branch and create a pull request.
- Confirm that the pull request passes relevant tests.
